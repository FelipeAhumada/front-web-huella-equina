    ...
    <section id="temporadas" className="py-20 lg:py-32 bg-primary">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          {/* Episodio principal - T2E7 grande al centro */}
          {season2Episodes.length > 0 && (() => {
            const mainEpisode = season2Episodes.find((e) => e.episodeNumber === 7)
          ...
          {season2Episodes.filter((e) => e.episodeNumber !== 7).length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {season2Episodes
                .filter((e) => e.episodeNumber !== 7)
